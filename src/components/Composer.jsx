    ...
    <div className="mx-auto max-w-2xl px-4 py-6">
      ...
      <form onSubmit={submit} className="space-y-4 rounded-lg border border-line bg-panel p-4">
          ...
          <>
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input className={field} value={pair} onChange={(e) => setPair(e.target.value)} placeholder="EUR/USD" />
              </div>
              <div>
                ...
                <div className="flex rounded-md border border-line bg-ink p-1">
                  <button
                    ...
                    className={`flex-1 rounded py-1.5 text-sm font-semibold ${direction === 'buy' ? 'bg-long/15 text-long' : 'text-mute'}`}
                  >
                    Buy
                  </button>
                  <button
                    ...
                    className={`flex-1 rounded py-1.5 text-sm font-semibold ${direction === 'sell' ? 'bg-short/15 text-short' : 'text-mute'}`}
                  >
                    Sell
                  </button>
                </div>
            ...
            <div>
              ...
              <input className={field} value={timeframe} onChange={(e) => setTimeframe(e.target.value)} placeholder="4H" />
            </div>
        ...
        <div className="flex justify-end gap-2 pt-1">
          ...
          <button type="submit" className="rounded-md bg-accent px-4 py-2 text-sm font-semibold text-white hover:bg-accent/90">
